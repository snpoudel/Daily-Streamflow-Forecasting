#!/bin/bash
#SBATCH --job-name=xgb-lag            # Job name
#SBATCH --output=xgb-lag%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=xgb-lag%j.log        # Error file name (%j expands to jobID)
...
#SBATCH --exclusive                     # Exclusive node allocation                     # Exclusive node allocation
...
mpirun python3 2.2xgboost_lag_model.py
