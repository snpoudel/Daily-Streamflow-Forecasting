...
#SBATCH --output=sarimax%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=sarimax%j.log        # Error file name (%j expands to jobID)
...
mpirun python3 1.1sarimax_model.py
