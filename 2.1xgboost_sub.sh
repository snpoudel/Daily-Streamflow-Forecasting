...
#SBATCH --output=xgb%j.log       # Output file name (%j expands to jobID)
#SBATCH --error=xgb%j.log        # Error file name (%j expands to jobID)
...
mpirun python3 2.1xgboost_model.py
